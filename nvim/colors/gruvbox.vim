...
let s:gb.light4 = ['928374', 243]     " 124-111-100

let s:gb.light4_256 = ['a89984', 246] " 168-153-132

"let s:gb.red    = ['fb4934', 167]     " 251-73-52
let s:gb.red    = ['fb4f3a', 167]     " 251-73-52
...
call s:HL('DiagnosticInfo', 'fg')
call s:HL('DiagnosticHint', 'blue')
call s:HL('DiagnosticOk', 'green')
