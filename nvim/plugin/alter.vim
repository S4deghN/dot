...
if exists('g:loaded_alter')
    finish
endif
let g:loaded_alter = 1
...
"
" E.g. if you are editing foo.c and need to edit foo.h simply execute :A and you will be editting
" foo.h, to switch back to foo.c execute :A again.
"
