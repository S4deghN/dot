...
c.aliases = {
    ...
    'dpi': 'set content.proxy http://192.168.1.100:8080',
...
## Type: QtColor
c.colors.tabs.pinned.selected.even.bg = tabs_selected_color
...
## Type: QtColor
c.colors.tabs.pinned.selected.odd.bg = tabs_selected_color
...
## Type: QtColor
c.colors.tabs.selected.even.bg = tabs_selected_color
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = tabs_selected_color
...
c.hints.chars = 'asdfghjklzxcvbnmqwertyuiop'
...
## Type: List of Perc
c.zoom.levels = ['25%', '33%', '50%', '67%', '75%', '90%', '100%', '110%', '120%', '130%', '140%', '150%', '175%', '200%', '250%', '300%', '400%', '500%']
...
config.bind('<Ctrl-T>', 'open -t ;; cmd-set-text -s :open -s')
...
config.bind('wo', 'cmd-set-text -s :open -w -s')
# config.bind('wp', 'open -w -- {clipboard}')
# config.bind('xO', 'cmd-set-text :open -b -r {url:pretty}')
config.bind('xo', 'cmd-set-text -s :open -b -s')
