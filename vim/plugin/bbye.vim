...
command! -bang -complete=buffer -nargs=? Bdelete :call s:bdelete("bdelete", <q-bang>, <q-args>)

command! -bang -complete=buffer -nargs=? Bwipeout :call s:bdelete("bwipeout", <q-bang>, <q-args>)
